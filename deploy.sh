...
PORT=3070 HOST=127.0.0.1 pm2 restart rasa_tech --update-env 2>/dev/null || (cd /root/rasa_tech/.output && PORT=3070 HOST=127.0.0.1 pm2 start server/index.mjs --name rasa_tech --cwd /root/rasa_tech/.output)
